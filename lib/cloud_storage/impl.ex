  ...
  defmacro __using__(:cloud_storage) do
    quote do
      ...
      def list_objects(bucket, query_params) do
        request_query(:get, bucket, [], "", "?" <> parse_query_params(query_params, ""))
      end
      ...
      """
      @spec set_bucket_versioning(bucket :: binary, versioning_config :: binary) ::
              HTTPResponse.t()
      ...
      [{param_1, value_1}, {param_2, value_2}].
      """
      @spec delete_object(bucket :: binary, object :: binary, query_params :: [{binary, binary}]) ::
              HTTPResponse.t()
      ...
      permission.
      """
      @spec get_object(bucket :: binary, object :: binary, query_params :: [{binary, binary}]) ::
              HTTPResponse.t()
      def get_object(bucket, object, query_params) do
        request_query(:get, bucket, [], "", object <> "?" <> parse_query_params(query_params, ""))
      end
      ...
      [{param_1, value_1}, {param_2, value_2}].
      """
      @spec get_object_metadata(bucket :: binary, object :: binary, [{binary, binary}]) ::
              HTTPResponse.t()
      ...
      'new_object'.
      """
      @spec copy_object(new_bucket :: binary, new_object :: binary, source_object :: binary) ::
              HTTPResponse.t()
      ...
      """
      @spec set_object_acl(bucket :: binary, object :: binary, acl_config :: binary) ::
              HTTPResponse.t()
      ...
      defp parse_query_params([{param, val} = _head | []], query),
        do: query <> param <> "=" <> val
